...
export const aboutSections: AboutSection[] = [
  {
    ...
    paragraphs: [
      "새로운 환경이나 익숙하지 않은 문제를 마주했을 때 오래 멈춰 있기보다, 먼저 상황을 파악하고 필요한 것을 빠르게 배우며 움직이는 편입니다. 학부생 시절부터 수업 안에만 머무르지 않고 게임 개발 동아리, 해커톤, IT 컨퍼런스, 창업 프로젝트 등 다양한 경험에 직접 뛰어들며 낯선 환경에 적응하는 힘을 길러왔습니다. 이후 토스 커머스 QA 업무를 경험하며 빠르게 바뀌는 서비스 환경 속에서 기획 변경, 정책 변화, 배포 일정에 맞춰 문제를 이해하고 정리하는 법을 배웠습니다. 최근 AI처럼 일하는 방식 자체를 바꾸는 기술이 등장했을 때도, 변화를 막연히 두려워하기보다 직접 써보고 이해하며 제 방식으로 흡수하려고 했습니다.",
    ],
  },
  {
    number: "02",
  ...
  },
  {
    number: "05",
    koreanTitle: "AI 활용력",
    englishTitle: "AI-Augmented Problem Solving",
