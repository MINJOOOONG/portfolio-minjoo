...
export const aboutSections: AboutSection[] = [
  ...
  },
  {
    ...
    sentence:
      "저는 AI를 사랑합니다. 그리고 그 사랑을 실제로 만들고 검증하는 방식으로 증명하려는 사람입니다.",
    paragraphs: [
      "저에게 AI는 단순히 답을 대신 내주는 도구가 아닙니다. 막연한 아이디어를 빠르게 구조화하고, 반복되는 작업을 줄이며, 실행 가능한 결과물로 바꿔주는 강력한 협업 파트너입니다. 저는 Claude와 Codex를 활용해 테스트 케이스 정리, 업무 자동화 아이디어 구체화, 코드 리팩터링, 문서 구조화, 포트폴리오 개선 작업까지 실제 업무와 개인 프로젝트 전반에 AI를 적극적으로 적용해왔습니다.",
      "하지만 AI를 좋아한다는 것은 결과물을 그대로 믿는다는 뜻이 아니라고 생각합니다. 오히려 더 많이 의심하고, 더 꼼꼼하게 검증해야 합니다. 그래서 저는 AI가 만든 결과물의 의도, 구조, 리스크를 다시 확인하고, 공식 문서와 실제 동작을 통해 검증하는 과정을 중요하게 생각합니다.",
      "저는 AI를 유행처럼 소비하는 사람이 아니라, AI와 함께 더 빠르게 만들고, 더 정확하게 검증하고, 더 나은 일하는 방식을 실험하는 사람이 되고 싶습니다.",
    ],
    detailLink: {
